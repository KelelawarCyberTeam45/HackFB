...
print '\x1b[1;32mLogin dulu su :v '
import os, sys
...
if sandi == 'kctpusat2k20' and user == 'keluarga':
    print 'welcome nyet :v'
    sys.exit
else:
    print 'Login gagal, hubungi 081286692145 !'
    restart()
